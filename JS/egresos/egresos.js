...
//EXPORT TABLES
const btnExportar3 = document.querySelector("#btnExportar3"),
tablaEgresos = document.querySelector("#tablaEgresos");
const btnExportar4 = document.querySelector("#btnExportar4"),
tablaCategEgr = document.querySelector("#tablaCategEgresos");
...
const cantidades = obtenerCantidadesCategEgr(lD, categorias, mesActualNombre, anioActual)

cargarTablaCategEgr(categorias, cantidades, totales);
...
//AL CLIQUEAR EXPORTAR TABLA DE EGRESOS
btnExportar3.addEventListener("click", function() {

    let tableExport = new TableExport(tablaEgresos, {
        exportButtons: false, // No queremos botones
        filename: `Egresos - ${mesActualNombre}-${anioActual}`, //Nombre del archivo de Excel
        sheetname: `Egresos`, //Título de la hoja
    });

    let datos = tableExport.getExportData();
    let preferenciasDocumento = datos.tablaEgresos.xlsx;
    tableExport.export2file(preferenciasDocumento.data, preferenciasDocumento.mimeType, preferenciasDocumento.filename, preferenciasDocumento.fileExtension, preferenciasDocumento.merges, preferenciasDocumento.RTL, preferenciasDocumento.sheetname);

});


//AL CLIQUEAR EXPORTAR TABLA DE CATEGORIA EGRESOS
btnExportar4.addEventListener("click", function() {

    let tableExport = new TableExport(tablaCategEgr, {
        exportButtons: false, // No queremos botones
        filename: `Categorias_Egresos - ${mesActualNombre}-${anioActual}`, //Nombre del archivo de Excel
        sheetname: `Categorias_Egresos`, //Título de la hoja
    });

    let datos = tableExport.getExportData();
    let preferenciasDocumento = datos.tablaCategEgresos.xlsx;
    tableExport.export2file(preferenciasDocumento.data, preferenciasDocumento.mimeType, preferenciasDocumento.filename, preferenciasDocumento.fileExtension, preferenciasDocumento.merges, preferenciasDocumento.RTL, preferenciasDocumento.sheetname);
